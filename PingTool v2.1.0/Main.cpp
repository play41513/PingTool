...
DWORD WINAPI LANExecute(LPVOID Param)
{
	if(frmMain->gLAN_NAME == "")
	{
		...
		PORT->ChangeLanSpeed(frmMain->g_DevVPID, "{4d36e972-e325-11ce-bfc1-08002be10318}", frmMain->gLAN_NAME,frmMain->bUSB3);
	return 0;
}
