...
#define SWITCH_SBC_MODE		10
#define WAIT_CLOSE_SBC_MODE	11
#define CLOSE_SBC_MODE		12
#define BUTTEN_POWER_OFF_VALUE	13
...
__published:	// IDE-managed Components
	...
	void __fastcall SBC1Click(TObject *Sender);
