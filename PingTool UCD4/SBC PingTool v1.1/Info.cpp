...
void __fastcall TfrmInfo::Logging(){
	...
	LOG_INFO()<< (((AnsiString)macset_edit->Text).c_str());
	LOG_INFO()<< _T("LAN_TEST_INFO");
	LOG_INFO()<< (((AnsiString)LAN_Ping->Text).c_str());
	LOG_INFO()<< _T("SET END:////////////////////////////////");
}
