...
__published:	// IDE-managed Components
	...
	TCheckBox *ckbStaticIP;
	TPanel *plServerIP;
	TPanel *Panel11;
	TPanel *Server_IP_Title;
	TPanel *Panel5;
	TPanel *plOk_ServerIP;
	TPanel *plChanel_ServerIP;
	TPanel *Panel13;
	TComboBox *cbNetwork;
	TImage *ImgRefresh;
	TPanel *Panel14;
	TPanel *Panel17;
	TPanel *plNetworkCardMAC;
	TCheckBox *ckb2500MSpeed;
	TCheckBox *ckbUSB2;
	TCheckBox *ckb2500M;
	...
	void __fastcall plOk_ServerIPClick(TObject *Sender);
	void __fastcall plChanel_ServerIPClick(TObject *Sender);
	void __fastcall ImgRefreshClick(TObject *Sender);
	void __fastcall cbNetworkChange(TObject *Sender);
	void __fastcall ckb2500MClick(TObject *Sender);
